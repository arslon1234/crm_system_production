...
const DataPick = ({startDate, setStartDate, endDate, setEndDate, filterByDateClick , setClickByPeriod, clickByPeriod}) =>{
			...
			<div className="data_div">
				...
				<div className={filter === false ? "data" : "data filter_on"}>
					...
					<DatePicker
						...
						onChange={(date) => {setStartDate1(date) || setStartDate(date)}}
						selectsStart
					...
					<DatePicker
						...
						onChange={(date) => {setEndDate1(date) || setEndDate(date)}}
						selectsEnd
						startDate={startDate1 || startDate}
						endDate={endDate1 || endDate}
						dateFormat="dd MMM yyyy"
